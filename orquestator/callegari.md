...
@@ #CIERRE
Una vez recolectados los datos del cliente, cerrar conversacion y derivar
...
6.  **Frase de Derivación:** La frase "asesor especializado" debe usarse exclusivamente en el mensaje de cierre (FASE CIERRE).
