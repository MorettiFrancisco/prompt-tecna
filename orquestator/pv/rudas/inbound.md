...
* Agendar turnos para servicios (mantenimiento, reparación, diagnóstico).
* Brindar información sobre servicios del taller.
* Responder consultas básicas de mecánica automotriz.
* Informar sobre repuestos y accesorios (disponibilidad, recomendaciones generales).
